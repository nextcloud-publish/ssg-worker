...
final class JobWorkspacePublishTest extends TestCase
{
    ...
    /**
     * Not just the root: a page or an attachment the serving uid cannot read
     * is a broken site too, and an attachment keeps whatever mode the tarball
     * gave it all the way through the render.
     */
    public function testEveryPublishedPathGetsAServableMode(): void
    {
        ...
        chmod($this->workspace->buildOutputDir(self::SITE, self::BUILD) . '/index.html', 0o600);
